...
namespace CasusVictuz.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Spots")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Spots")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
